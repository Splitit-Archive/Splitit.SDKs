...
public class ApiClient {
    ...
    public ApiClient() {
        ...
        this.defaultHeaderMap.put("Splitit-SDK", "Java-1.6.5523");
    ...
    public <T> T handleResponse(Response response, Type returnType) throws ApiException {
        if (response.isSuccessful()) {
            if (returnType == null || response.code() == 204) {
                ...
                T result = deserialize(response, returnType);
                this.ThrowIfUnsuccessfullResponse(result);
                return result;
            }
        } else {
    ...
    private void ThrowIfUnsuccessfullResponse(Object result) throws ApiException{
        try {
            Method method = result.getClass().getMethod("getResponseHeader");
            ResponseHeader responseHeader = (ResponseHeader)method.invoke(result);
            if (!responseHeader.isSucceeded()){
                throw ApiException.fromResponseHeader(responseHeader);
            }
