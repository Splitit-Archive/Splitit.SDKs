...
export class BaseAPI {
    ...
    private createFetchParams(context: RequestOpts) {
        ...
        const headers = Object.assign({}, this.configuration.headers, context.headers, {"Splitit-SDK": "TypeScript-1.6.5528"});
        const init = {
...
export interface ConfigurationParameters {
    ...
    touchPoint?: TouchPoint; // optionally set touch point
...
export class Configuration {
    private static _isSandbox: boolean;
    private static _touchPoint: TouchPoint;

    constructor(private configuration: ConfigurationParameters = {}) {
        if (Configuration._isSandbox) {
            configuration.basePath = BASE_PATH_SANDBOX;
        }
    ...
    get touchPoint(): TouchPoint | undefined {
        const touchPoint = this.configuration.touchPoint;
        if (touchPoint) {
            return touchPoint;
        }
        return undefined;
