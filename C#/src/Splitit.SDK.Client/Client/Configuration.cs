...
namespace Splitit.SDK.Client.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "1.6.5517";
        ...
        /// </summary>
        protected Configuration(string basePath = null)
        {
            UserAgent = "Swagger-Codegen/1.6.5517/csharp";
            BasePath = basePath ?? "https://webapi.production.splitit.com";
            DefaultHeader = new ConcurrentDictionary<string, string>();
            DefaultHeader["Splitit-SDK"] = "CSharp-NetCore-1.6.5517";
            ApiKey = null;
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    SDK Package Version: 1.6.5517\n";
